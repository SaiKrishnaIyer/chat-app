  ...
  return (
    ...
    max-sm:flex-col backdrop-blur-2xl'>
      ...
      <div className='flex items-center gap-2 text-sm text-gray-500'>
        <input type="checkbox" />
        <p>Agree to the terms of use & privercy policy</p>
      </div>
      ...
      <div className='flex flex-col gap-2'>
        {currState === "Sign up" ? (
          ...
          <span onClick={() => {setCurrState("Sign up")}} className='font-medium text-violet-500 cursor-pointer'>Sign up Here</span></p>
        )}
      </div>
      </form>
    </div>
